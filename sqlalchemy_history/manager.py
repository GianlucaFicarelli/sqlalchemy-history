...
class VersioningManager(object):
    ...
    :param unit_of_work_cls: The UnitOfWork class to use for initializing UnitOfWork objects for
            versioning
    :param transaction_cls: Transaction class to use for versioning. If None, the default
            Transaction class generated by TransactionFactory will be used.
    :param user_cls: User class which Transaction class should have relationship to. This
            can either be a class or string name of a class for lazy evaluation.
    :param options: Versioning options
    :param plugins: Versioning plugins that listen the events invoked by the manager.
    :param builder: Builder object which handles the building of versioning tables and
            models.
    ...
    def option(self, model, name):
        ...
        If the option is not found from this manager object either this method throws a KeyError.
    ...
    def apply_class_configuration_listeners(self, mapper):
        ...
        :param mapper: SQLAlchemy mapper to apply the class configuration listeners to
    ...
    def track_session(self, session):
        ...
        This method should be used in conjunction with `track_operations`.
    ...
    def after_flush(self, session, flush_context):
        ...
        session's connections and invokes the process_after_flush method of that object.
    ...
    def track_sql_operations(self, conn, cursor, statement, parameters, context, executemany):
        ...
        if op is not None:
            table_name = (
                context.invoked_statement.table.schema + "." + context.invoked_statement.table.name
            ...
            if table_name in table_names:
                for params in context.compiled_parameters:
                    self.append_association_operation(conn, table_name, params, op)
